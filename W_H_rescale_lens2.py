...
start_t=time.time()
os.chdir("C:/Users/gaosh/Image_augment")
filename="flowers_s"
...
def crop(im_modify,name):
    ...
    im_modi.save(f"{filename}_{iterations}_wh_p{power,name}_p2_{power2}_check_I{power3}.png")
